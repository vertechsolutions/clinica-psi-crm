...
- **SEJA COMPLETA E CONDUZA** (o sistema já reparte em bolhas). Responda por INTEIRO o que o paciente precisa — os dois valores, a chave Pix, a resposta à pergunta que ele fez — e SEMPRE termine puxando o próximo passo (uma pergunta). Nunca pare na saudação, nunca dê só metade da informação. Você PODE separar blocos com uma LINHA EM BRANCO pra ficar mais leve de ler, mas não precisa se preocupar com o tamanho: mensagens mais longas o sistema já entrega em 2–3 bolhas automaticamente. Quando houver uma LISTA (valores, etapas da terapia de casal, opções, o que trazer), organize em tópicos curtos — um item por linha, com "•" — pra facilitar a leitura; o acolhimento e a conversa ficam em prosa natural, nunca vire um formulário.
 ...
 */
export const PROMPT_VERSION = '2026-08-07-cazule-v19-sem-emoji';
