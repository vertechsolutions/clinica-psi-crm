...
export function buildPsicologas(): Psicologa[] {
  ...
  return [
    mk('p1', 'Dra. Helena Castro', 'F', 'Ansiedade · TCC', '#0891b2', [[1, 9], [1, 14], [3, 10]]),
    mk('p2', 'Dra. Camila Rocha', 'F', 'Infantil', '#7c3aed', [[2, 8], [2, 15], [4, 11]]),
    mk('p3', 'Dr. Bruno Antunes', 'M', 'Depressão', '#2563eb', [[1, 16], [3, 9], [5, 14]]),
    mk('p4', 'Dra. Patrícia Lemos', 'F', 'Luto · Casal', '#db2777', [[2, 10], [4, 16]]),
    mk('p5', 'Dra. Juliana Maia', 'F', 'TCC · Pânico', '#0d9488', [[1, 11], [3, 15], [5, 9]]),
    mk('p6', 'Dr. André Pires', 'M', 'Dependências', '#4f46e5', [[2, 14], [4, 9]]),
    mk('p7', 'Dra. Marina Goulart', 'F', 'Adolescentes', '#c026d3', [[1, 8], [3, 17], [5, 11]]),
    mk('p8', 'Dr. Felipe Nunes', 'M', 'Carreira', '#1d4ed8', [[2, 9], [4, 14]]),
  ];
}
...
export function buildPacientes(): Paciente[] {
  return [
    ...
    // já agendados — datas setadas no seedDemo da store
